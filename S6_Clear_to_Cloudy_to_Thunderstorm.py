...
# Clear skies -> partly cloudy -> cloudy -> overcast -> light rain -> rain -> thunderstorm -> rain -> light rain -> overcast -> cloudy -> partly cloudy ->clear skies
...
def main():
    ...
    stages = (
        ...
        (environment.PARTLY_CLOUDY, "partly_cloudy", "Partly Cloudy", 10),
        (environment.CLOUDY, "cloudy", "Cloudy", 10),
        (environment.OVERCAST, "overcast", "Overcast", 10),
        (environment.LIGHT_RAIN, "light_rain", "Light Rain", 10),
        (environment.RAIN, "rain", "Rain", 10),
        (environment.THUNDERSTORM, "thunderstorm", "Thunderstorm", 10),
        (environment.RAIN, "rain", "Rain", 10),
        (environment.LIGHT_RAIN, "light_rain", "Light Rain", 10),
        (environment.OVERCAST, "overcast", "Overcast", 10),
        (environment.CLOUDY, "cloudy", "Cloudy", 10),
